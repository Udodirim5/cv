      ...
      <div className="container mx-auto px-6 py-20 flex flex-col items-center text-center">
        ...
        >
          <div className="w-32 h-32 rounded-full border-4 border-cyan-400/30 bg-gray-800 flex items-center justify-center overflow-hidden">
            <div className="w-full h-full bg-gradient-to-br from-cyan-400/20 to-blue-600/20 animate-pulse">
              <img
                src={myInfo.image}
                alt="Avatar"
        ...
        >
          Senior <span className="text-cyan-400">React</span> Developer &{" "}
          <span className="text-blue-400">UI/UX</span> Specialist
        </motion.p>
